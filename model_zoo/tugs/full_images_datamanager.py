...
class FullImageDatamanager(DataManager, Generic[TDataset]):
    ...
    def create_train_dataset(self) -> TDataset:
        ...
        # CONSOLE.log(f"Train image: {self.train_dataparser_outputs.image_filenames}")
    ...
    def create_eval_dataset(self) -> TDataset:
        ...
        test_dataparser_outputs = self.dataparser.get_dataparser_outputs(split=self.test_split)
        CONSOLE.log(f"Test image: {test_dataparser_outputs.image_filenames}")
        return self.dataset_type(
            dataparser_outputs=test_dataparser_outputs,
            scale_factor=self.config.camera_res_scale_factor,
            cache_compressed_images=self.config.cache_compressed_images,
        )
